...
##### Update: The openai API access key is automaticly blocked when the code is uploaded. If interested, feel free to ask for the code and i will send it to you privately with a working key
